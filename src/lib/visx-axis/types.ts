import { D3Scale, NumberLike, ScaleInput, ValueOf } from '@/lib/visx-scale';
import { TextProps } from '@/lib/visx-text/lib/Text';
...
export type CommonProps<Scale extends AxisScale> = {
  ...
  /** Override the component used to render tick labels (instead of <Text /> from @/lib/visx-text). */
