...
export type GridProps<XScale extends GridScale, YScale extends GridScale> = Omit<
  ...
  CommonPropsToOmit
> & {
  /** `@/lib/visx-scale` or `d3-scale` object used to map from ScaleInput to x-coordinates (GridColumns). */
  xScale: XScale;
  /** `@/lib/visx-scale` or `d3-scale` object used to map from ScaleInput to y-coordinates (GridRows). */
  yScale: YScale;
