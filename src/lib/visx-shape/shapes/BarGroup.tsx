...
> = BaseBarGroupProps<Datum, Key> & {
  ...
  /** @/lib/visx-scale or d3-scale that takes an x0 value (position of group) and maps it to an x0 axis position of the group. */
  x0Scale: X0Scale;
  /** @/lib/visx-scale or d3-scale that takes a group key and maps it to an x axis position (within a group). */
  x1Scale: X1Scale;
  /** @/lib/visx-scale or d3-scale that takes an y value (Datum[key]) and maps it to a y axis position. */
