...
> = BaseBarGroupProps<Datum, Key> & {
  ...
  /** @/lib/visx-scale or d3-scale that takes a key value (Datum[key]) and maps it to an x axis position (width of bar). */
  xScale: PositionScale;
  /** @/lib/visx-scale or d3-scale that takes a y0 value (position of group) and maps it to a y axis position. */
  y0Scale: Y0Scale;
  /** @/lib/visx-scale or d3-scale that takes a group key and maps it to an y axis position (within a group). */
  y1Scale: Y1Scale;
