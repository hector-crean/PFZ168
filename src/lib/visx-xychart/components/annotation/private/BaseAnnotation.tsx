import { AnnotationProps } from '@/lib/visx-annotation/components/Annotation';
import { EditableAnnotationProps } from '@/lib/visx-annotation/components/EditableAnnotation';
import { AxisScale } from '@/lib/visx-axis';
import { ScaleInput, coerceNumber } from '@/lib/visx-scale';
...
>({
  ...
  if ((!propsXAccessor || !propsYAccessor) && !dataKey) {
    console.warn('[@/lib/visx-xychart/BaseAnnotation]: dataKey or x/yAccessors must be specified.');
    return null;
  }
