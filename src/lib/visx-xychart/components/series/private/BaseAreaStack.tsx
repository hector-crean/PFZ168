...
import { coerceNumber } from '@/lib/visx-scale';
import { LinePath, StackPathConfig } from '@/lib/visx-shape';
import Area, { AreaProps } from '@/lib/visx-shape/shapes/Area';
import { getFirstItem, getSecondItem } from '@/lib/visx-shape/util/accessors';
