import { AxisLeft } from '@/lib/visx-axis';
import { curveBasisOpen } from '@/lib/visx-curve';
import { LinearGradient } from '@/lib/visx-gradient';
import { GridAngle, GridRadial } from '@/lib/visx-grid';
import { Group } from '@/lib/visx-group';
import appleStock, { AppleStock } from '@/lib/visx-mock-data/mocks/appleStock';
import { ParentSize } from '@/lib/visx-responsive';
import { NumberLike, scaleLog, scaleTime } from '@/lib/visx-scale';
import { LineRadial } from '@/lib/visx-shape';
...
export type LineRadialProps = {
    width: number;
    height: number;
    data: Array<AppleStock>;
    animate?: boolean;
};

const RadialChart = ({ width, height, data, animate = true }: LineRadialProps) => {
...
const ResponsiveRadialChart = () => (
    <ParentSize>
        {({ width, height, top, left, ref, resize }) => (
            <RadialChart width={width} height={height} data={appleStock} />
        )}
    </ParentSize>
);

export { ResponsiveRadialChart };
