...
import {
	...
	CircleSubject,
	LineSubject,
} from "@/lib/visx-annotation";
import { LinePath } from "@/lib/visx-shape";
...
const ResponsiveAnnotatedChart = () => (
	<ParentSize>
		{({ width, height }) => <AnnotatedChart width={width} height={height} />}
	</ParentSize>
);

export { ResponsiveAnnotatedChart };
