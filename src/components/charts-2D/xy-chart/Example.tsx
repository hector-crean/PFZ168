import { CityTemperature } from '@/lib/visx-mock-data/mocks/cityTemperature';
...
const ExampleXYChart = ({ height }: XYChartProps) => {
  return (
    <ExampleControls>
      {({
        accessors,
...
const ResponsiveExampleXYChart = () => <ParentSize>{({ width, height }) => <ExampleXYChart width={width} height={height} />}</ParentSize>

export { ResponsiveExampleXYChart };
